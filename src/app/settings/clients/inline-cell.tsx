...
const cellButtonClasses =
  "block w-full truncate rounded px-1.5 py-0.5 text-left transition-colors hover:bg-overview-surface-hover disabled:cursor-not-allowed disabled:opacity-60";
