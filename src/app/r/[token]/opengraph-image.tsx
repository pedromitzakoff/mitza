...
export const alt = "KOFF — Relatório de Performance";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

/**
 * Etapa "OG Metadata do Relatório Público": imagem institucional KOFF pro
 * preview de compartilhamento do link (`/r/[token]`) — antes o WhatsApp/
 * Google Chat caíam no ícone genérico da plataforma (sem `opengraph-image`
 * nenhum existia em lugar algum da app). Paleta exata pedida pra esta peça
 ...
 * inválido/revogado/cliente excluído cai no mesmo cartão institucional sem
 * nenhuma informação específica — nunca uma métrica, nunca o `clientId`.
 */
    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          <div style={{ display: "flex", width: 12, height: 12, borderRadius: "50%", backgroundColor: LIME }} />
          <div style={{ display: "flex", fontSize: 28, fontWeight: 700, letterSpacing: "6px", color: GRAPHITE }}>KOFF</div>
        </div>
