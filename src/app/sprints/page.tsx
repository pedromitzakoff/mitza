...
export default async function SprintsPage({
  ...
  const reviewDetail: AccountReviewDetail | null = openReviewDetailRow
    ? {
        ...
        diagnosis: openReviewDetailRow.diagnosis,
