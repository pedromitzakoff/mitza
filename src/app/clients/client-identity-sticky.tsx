 ...
 * então não há altura nenhuma a descontar), mostra só nome + status — sem
 * gestor, conta Meta, período ou ações, que já estão no cabeçalho completo.
 * Some sozinho ao rolar de volta pro topo.
 */
