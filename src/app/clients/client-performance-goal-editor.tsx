 ...
 *
 * Etapa "MITZA Interaction Engine v1.5": o Portal/backdrop/posicionamento
 * deixou de ser reimplementado aqui — usa `FloatingPortalPanel`
 * (`@/lib/floating-menu`), o mesmo componente compartilhado que
 * `TaskRowMenu` (`task-row.tsx`) usa. Nenhuma classe, papel ARIA ou
 * comportamento mudou — só a duplicação entre os dois saiu.
 */
